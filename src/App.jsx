...
// ---------- Satınalma Siparişi ----------
function SatinalmaSiparis({ satinalmaSiparisler, satinalmaTalepler, depoStok, kullanici, formAyarlari, taslak, taslakTemizle }) {
  const [fisAcik, setFisAcik] = useState(false);
              ...
              {filtrelenmis.map((s) => (
                <tr key={s.id}>
                  ...
                  <td style={{ whiteSpace: "nowrap" }}>
                    ...
                    <button onClick={() => sil(s)} style={{ background: "none", border: "none", color: "#6b7178", cursor: "pointer", padding: 4 }}><Trash2 size={14} /></button>
                  </td>
                </tr>
              ))}
            </tbody>
